...
Map {
  south-pole-color: @landmass_fill;
...
//water
@water:              #d5e8eb;//#b0d0d6; //desaturate(#A0DBE6,26);
@rivers_stroke:      #cce7ea; //rgb(204,231,234);
@water_shadow:       #bfdae9;//#e2eef0; //lighten(@water,15);
...
@building_a:          #f6efe4; //lighten(@buildings,2);
