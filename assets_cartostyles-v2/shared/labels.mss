...
#transportation_name['mapnik::geometry_type'=2]{
  ...
  [class='track'][zoom>=18]{
    ...
    [class='minor'],
    [class='service']{
      text-size: linear([view::zoom], (16, 9.5), (18, 11.5));
    }
    [class='path'],
    [class='track']{
...
#poi['nuti::pois'>0]{
  ...
  [zoom>=18]{
    ::icon[class!=null] {
      ...
      marker-file: url('icons/[class]-11.svg');
      marker-width: linear([view::zoom], (14, 9.0), (15, 10.0), (16, 11.0), (18, 12.0)) - 0.000001 * [rank];
    }
    ::label[name!=null]['nuti::pois'>1] {
      text-name: @name;
      text-face-name: @mont;
      ...
      text-avoid-edges: true;
      text-fill: @poi_dark;
      text-size: linear([view::zoom], (14, 7.0), (15, 8.0), (16, 9.0), (18, 10.0)) - 0.000001 * [rank];
...
#poi['nuti::pois'=0]{
  ...
  [class='stadium'][rank<=3],
  [class='cemetery'][rank<=3],
  [class='attraction'][rank<=3]{
    [zoom>=15][rank<=1],
    [zoom>=16][rank<=2],
    [zoom>=17][rank<=3],
    [zoom>=18]{
